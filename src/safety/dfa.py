...
Taken from https://bitbucket.org/RToroIcarte/lpopl/src/master/src/dfa.py
"""
...
if __name__ == '__main__':
    ...
    d = DFA(formula)
    print(d)
    print(d.state, formula)
    formula = d.progress_LTL(formula, ['b'])
    print(d.state, formula)
    formula = d.progress_LTL(formula, ['b'])
    print(d.state, formula)
    formula = d.progress_LTL(formula, ['a', 'b'])
    print(d.state, formula)
    formula = d.progress_LTL(formula, ['b'])
    print(d.state, formula)
